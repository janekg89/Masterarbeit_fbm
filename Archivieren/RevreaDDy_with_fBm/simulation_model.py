...
class Sim_Complex():
    def __init__(self,Diffusion,reactiondistance,micro_reactionrate_forward,micro_reactionrate_backward,micro_reactionrate_complex,alpha,trajectory_length,boxsize,particles,timestep):
       ...
       :param Diffusion: Diffusion of substrate
       :param reactiondistance:
       :param micro_reactionrate_forward:
       :param micro_reactionrate_backward:
       :param micro_reactionrate_complex:
       :param alpha:
       ...
       :return:
        ...
        self.path=self.path()
        self.radial_time_range=np.arange(100,2**14,1) # the time range where the radial disitrbution is observate.
    ...
    def stamp(self):
        ...
        return stamp
    def path(self):
        path= "./revreaddy_data/" +"rate_f"+str(self.micro_reactionrate_forward)+"rate_b"+str(self.micro_reactionrate_backward)+"rate_c"+str(self.micro_reactionrate_complex)+"alpha"+str(self.alpha)+"S_num"+str(self.particles)+"length"+str(self.length)+"R"+str(self.reactiondistance)+"boxsize"+str(self.boxsize)+"D"+str(self.Diffusion)+"/"
