...
\begin{figure}
  ...
  \captionsetup{width=\linewidth}
  \captionof{figure}{The radial distribution function \ref{eq:messsungradial} of the substrates around the enzyme/complex was sampled in the range of ($100 \Delta t<t<2^{14}\Delta t$) and plotted as error-bar with the width of the standard deviation. The Erban-Chapman \ref{erbanchapmanradial1} result was plotted as a solid black line.\\ green: One-way reaction:  $\lambda_+=0.1/\Gamma$, $\lambda_-=0$,  $\lambda_c=1.0/\Gamma$.\\blue: One-way "diffusion-limited" reaction: $\lambda_+=3.0/\Gamma$, $\lambda_-=0$,  $\lambda_c=3.0/\Gamma$  }
...
\begin{figure}
  ...
  \begin{small}
  \begin{itemize}
  \item green: One-way reaction:  $\lambda_+=0.1/\Gamma$, $\lambda_-=0$,  $\lambda_c=1.0/\Gamma$.
...
\subsubsection{Results for "Diffusion-Limited" One-way Reaction}
\begin{figure} [h]
  \centering
  \includegraphics[width=\textwidth]{./data/diffusion-limit-concentractionlambdaminus_k1}
  \captionsetup{width=\linewidth}
  \captionof{figure}{  One-way "diffusion-limited" reaction was tried to reach by: $1 /\Gamma\leq\lambda_+\leq3.0/\Gamma$.  $\lambda_c=1.0/\Gamma$, $\lambda_-=0$. $k^{QSSA}_{+}$ was calculated and displayed as empty circles. The dashed blue line describes the diffusion limit \cref{difkinetics}}
...
\begin{figure}[h]
  ...
  \captionsetup{width=\linewidth}
  \captionof{figure}{For the Michaelis Menten scenario: $\lambda_+=1.0/\Gamma$, $\lambda_-=1.0/\Gamma$,  $\lambda_c=0.1/\Gamma$, the radial distribution function \ref{eq:messsungradial} of the substrates around the enzyme/complex was sampled in the range of ($100 \Delta t<t<2^{14}\Delta t$) and plotted as error-bar with the width of the standard deviation. The Erban-Chapman \ref{erbanchapmanradial1} result was plotted as a solid black line.}
...
\end{align}
with $h$ the fractal kinetics exponent. Its value is zero for classic kinetics.  For diffusion limited kinetics Kopelman derived a scaling theory. 
...
\begin{figure}[h]
  ...
  \captionsetup{width=\linewidth}
  \captionof{figure}{The radial distribution function \ref{eq:messsungradial} of the substrates around the enzyme/complex was sampled in the range of ($100 \Delta t<t<2^{14}\Delta t$) and plotted as error-bar with the width of the standard deviation and microscopic reaction set to: $\lambda_+=1.0/\Gamma$, $\lambda_-=1.0$,  $\lambda_c=1.0/\Gamma$.\\ green: Michaelis Menten with Bm: $\alpha=1.0$
...
2. show one scenario with the idea of fastest possible fractional reaction. conclusion still slower than Brownian motion. No scenario good be found, which is faster than Brownian motion.




\subsection{Time-depended reaction rates}
...
\end{figure}
The random walk dimension $d_w=2/\alpha$ is describing the 

3. Show Kopelman. make table.
...
\cref{fig:k1differentalphawithfitbetter}. Can be shown that k(t) indeed describes the kinetics of MM with fractional Brownian motion. 
...
\centering
\includegraphics[width=\textwidth]{./data/hvsalpha.png}
\caption{default}
\label{fig:figure1}
\end{minipage}
\hspace{0.5cm}
...
\begin{figure}[h]
  ...
  \captionlistentry[table]{h vs. $\alpha$}
  
  \captionsetup{labelformat=andtable}
  \captionof{figure}{h vs. $\alpha$}
  \label{fig:k1differentalphawithfitbetter}
\end{figure}
