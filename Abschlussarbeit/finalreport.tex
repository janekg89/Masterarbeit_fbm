...
\begin{figure}
  ...
  \captionsetup{width=\linewidth}
  \captionof{figure}{The radial distribution function \ref{radialcalcutaltion} of the substrates around the enzyme/complex was sampled for $100 \Delta t<t<2^{14}\Delta t$ and plotted as error-bar with the width of the standard deviation. The Erban-Chapman result was plotted as a green dashed line for bigger than the reaction radius $\sigma$  and a red dashed line for smaller than $\sigma$. Parameters were set to:  $\lambda_+=0.1$, $\lambda_-=0$,  $\lambda_c=1.0$ and the box size $l^3=8^3$.}
...
\begin{align} \label{radialcalcutaltion}
