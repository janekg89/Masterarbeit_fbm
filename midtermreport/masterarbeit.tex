...
\begin{minipage}{.5\textwidth}
  ...
  \captionof{figure}{Profiling c++ and python code in respect to trajectory length}
  \label{fig:test1}
\end{minipage}%
\begin{minipage}{.5\textwidth}
  \centering
  ...
  \captionsetup{width=0.9\linewidth}
  \captionof{figure}{Profiling c++ and python code in respect to trajectory number}
  \label{fig:test2}
\end{minipage}
\end{figure}
