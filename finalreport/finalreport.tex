...
Complex bildung möglich machen nach Michaelis Menden. -> da reaction number integrieren
...
\begin{figure}[h!]
  ...
  \captionsetup{width=\linewidth}
  \captionof{figure}{number of substrates in a RevReaDDy simulation of brownian motion vs fractional brownian motion with $\alpha=0.5$ with 500 particles of one type with Diffusion constant = 0.2, a pseudo enzymatic reatcion s+e=p+e ,reaction dsitance = 2.0,reactionrate forward 0.5, reaction rate backward= 0.1, boxsize = 30,  dt=1.0, avraged over 10 runs, 16384 timesteps}
...
\begin{figure}[h!]
  ...
  \label{fig:forward reaction2}
\end{figure}

\begin{figure}[h!]
  \centering
  \includegraphics[width=\textwidth]{./data/changealpha.png}
  \captionsetup{width=\linewidth}
  \captionof{figure}{number of forward reactions in a RevReaDDy simulation of brownian motion vs fractional brownian motion with differnet $\alpha$ with 500 particles of one type with Diffusion constant = 0.2, a pseudo enzymatic reatcion s+e=p+e ,reaction dsitance = 2.0,reactionrate forward 0.5, reaction rate backward= 0.1, boxsize = 30,  dt=1.0, avraged over 2 runs,4096 timestep}
  \label{fig:forward reaction1}
\end{figure} 


\begin{figure}[h!]
  \centering
  \includegraphics[width=\textwidth]{./data/michaelismenten_brownian.png}
  \captionsetup{width=\linewidth}
  \captionof{figure}{RevReaDDy simulation of brownian motion  with 400 substrate and 150 enyyme  of one type with Diffusion constant = 0.2,  s+e=c=p+e ,reaction dsitance = 0.3, first reactionrate forward 50,0, reaction rate backward= 0.2, second reactionrate forward 0,second reaction rate backward= 0.1, boxsize = 10,  dt=0.01, 8000 timesteps}
  \label{fig:amount of particles michaelis menten brownian}
\end{figure}

\begin{figure}[h!]
  \centering
  \includegraphics[width=\textwidth]{./data/michaelismenten_fractionalbrownian.png}
  \captionsetup{width=\linewidth}
  \captionof{figure}{RevReaDDy simulation of fractional brownian motion with alpha 0.5 with 400 substrate and 150 enyyme  of one type with Diffusion constant = 0.2,  s+e=c=p+e ,reaction dsitance = 0.3, first reactionrate forward 50,0, reaction rate backward= 0.2, second reactionrate forward 0,second reaction rate backward= 0.1, boxsize = 10,  dt=0.01, 8000 timesteps}
  \label{fig:amount of particles michaelis menten fractional}
\end{figure}

\section{new stuff}
\begin{figure}[h!]
  \centering
  \includegraphics[width=\textwidth]{./data/partnum_50_a_0p5_lambda0p8xlog.png}
  \captionsetup{width=\linewidth}
  \captionof{figure}{ alpha0.5}
  \label{fig:kineticsreactionkonstatvariationlog}
\end{figure}
\begin{figure}[h!]
  \centering
  \includegraphics[width=\textwidth]{./data/radialpartnum_50_a_0p5_labda0p8.png}
  \captionsetup{width=\linewidth}
  \captionof{figure}{radialdistributionfunction}
  \label{fig:radialabc}
\end{figure}

\begin{figure}[h!]
  \centering
  \includegraphics[width=\textwidth]{./data/shortsimulations_time_differentreactionstime.png}
  \captionsetup{width=\linewidth}
  \captionof{figure}{ variation of reaction konstant}
  \label{fig:kineticsreactionkonstatvariation}
\end{figure}

\begin{figure}[h!]
  \centering
  \includegraphics[width=\textwidth]{./data/shortsimulations_time_differentreactionstime_rightstartingposition.png}
  \captionsetup{width=\linewidth}
  \captionof{figure}{ variation of reaction konstant 0.06,0.11,0.81,1.41, partnum=200}
  \label{fig:kineticsreactionkonstatvariationpositionright}
\end{figure}

\begin{figure}[h!]
  \centering
  \includegraphics[width=\textwidth]{./data/kinectics_longtrajectory_alpha0p5und1p0.png}
  \captionsetup{width=\linewidth}
  \captionof{figure}{ variation of alpha}
...
\begin{figure}[h!]
  \centering
  \includegraphics[width=\textwidth]{./data/kinectics_longtrajectory_alpha0p5und1p0xlog.png}
  \captionsetup{width=\linewidth}
  \captionof{figure}{ variation of alpha}
